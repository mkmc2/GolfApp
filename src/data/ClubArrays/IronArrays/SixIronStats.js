...
export const SixIronData = () => {
    ...
    return {
        ...
        sixIronShotTotalCounter100,
        sixIronShotCounter75,
        setSixIronShotCounter75,
        sixIronShotTotalCounter75,
        sixIronShotCounter50,
        setSixIronShotCounter50,
        sixIronShotTotalCounter50,
        sixIronShotCounter25,
        setSixIronShotCounter25,
        sixIronShotTotalCounter25,
        // Historical Value
        calculateHistoricalAverageSixIron100,
        calculateHistoricalAverageSixIron75,
        calculateHistoricalAverageSixIron50,
        calculateHistoricalAverageSixIron25,
        // Variance
        calculateHighVarianceSixIron100,
        calculateHighVarianceSixIron75,
        calculateLowVarianceSixIron100,
        calculateLowVarianceSixIron75,
    };
};
