...
export const TwoIronData = () => {
    ...
    return {
        ...
        twoIronShotTotalCounter100,
        twoIronShotCounter75,
        setTwoIronShotCounter75,
        twoIronShotTotalCounter75,
        twoIronShotCounter50,
        setTwoIronShotCounter50,
        twoIronShotTotalCounter50,
        twoIronShotCounter25,
        setTwoIronShotCounter25,
        twoIronShotTotalCounter25,
        // Historical Value
        calculateHistoricalAverageTwoIron100,
        calculateHistoricalAverageTwoIron75,
        calculateHistoricalAverageTwoIron50,
        calculateHistoricalAverageTwoIron25,
        // Variance
        calculateHighVarianceTwoIron100,
        calculateHighVarianceTwoIron75,
        calculateLowVarianceTwoIron100,
        calculateLowVarianceTwoIron75,
    };
};
