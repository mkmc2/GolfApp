...
export const ThreeIronData = () => {
    ...
    return {
        ...
        threeIronShotTotalCounter100,
        threeIronShotCounter75,
        setThreeIronShotCounter75,
        threeIronShotTotalCounter75,
        threeIronShotCounter50,
        setThreeIronShotCounter50,
        threeIronShotTotalCounter50,
        threeIronShotCounter25,
        setThreeIronShotCounter25,
        threeIronShotTotalCounter25,
        // Historical Value
        calculateHistoricalAverageThreeIron100,
        calculateHistoricalAverageThreeIron75,
        calculateHistoricalAverageThreeIron50,
        calculateHistoricalAverageThreeIron25,
        // Variance
        calculateHighVarianceThreeIron100,
        calculateHighVarianceThreeIron75,
        calculateLowVarianceThreeIron100,
        calculateLowVarianceThreeIron75,
    };
};
