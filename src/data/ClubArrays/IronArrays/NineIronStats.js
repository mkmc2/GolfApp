...
export const NineIronData = () => {
    ...
    return {
        ...
        nineIronShotTotalCounter100,
        nineIronShotCounter75,
        setNineIronShotCounter75,
        nineIronShotTotalCounter75,
        nineIronShotCounter50,
        setNineIronShotCounter50,
        nineIronShotTotalCounter50,
        nineIronShotCounter25,
        setNineIronShotCounter25,
        nineIronShotTotalCounter25,
        // Historical Value
        calculateHistoricalAverageNineIron100,
        calculateHistoricalAverageNineIron75,
        calculateHistoricalAverageNineIron50,
        calculateHistoricalAverageNineIron25,
        // Variance
        calculateHighVarianceNineIron100,
        calculateHighVarianceNineIron75,
        calculateLowVarianceNineIron100,
        calculateLowVarianceNineIron75,
    };
};
