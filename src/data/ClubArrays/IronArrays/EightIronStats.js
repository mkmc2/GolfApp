...
export const EightIronData = () => {
    ...
    return {
        ...
        eightIronShotTotalCounter100,
        eightIronShotCounter75,
        setEightIronShotCounter75,
        eightIronShotTotalCounter75,
        eightIronShotCounter50,
        setEightIronShotCounter50,
        eightIronShotTotalCounter50,
        eightIronShotCounter25,
        setEightIronShotCounter25,
        eightIronShotTotalCounter25,
        // Historical Value
        calculateHistoricalAverageEightIron100,
        calculateHistoricalAverageEightIron75,
        calculateHistoricalAverageEightIron50,
        calculateHistoricalAverageEightIron25,
        // Variance
        calculateHighVarianceEightIron100,
        calculateHighVarianceEightIron75,
        calculateLowVarianceEightIron100,
        calculateLowVarianceEightIron75,
    };
};
